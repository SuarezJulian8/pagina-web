...
import pickle as pl 
import numpy as np 
st.title("Prediccion de los precios para casas")
data = pd.read_csv("hprice.csv")
with open("Lr.pickle", "rb") as f:
    Lr = pl.load(f)
#Widgest para la entrada de datos 
...
colonial = st.radio("¿Es colonial?", ("Si", "No"))
...
colonial_binary = 1 if colonial == "Si" else 0 
